...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("AnEternityUnderWater", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("AnEternityUnderWater", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "AnEternityUnderWater";
		app.meta["name"] = "AnEternityUnderWater";
